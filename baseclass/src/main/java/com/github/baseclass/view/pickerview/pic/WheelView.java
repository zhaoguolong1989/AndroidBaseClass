...
package com.github.baseclass.view.pickerview.pic;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setColor(0xFF262626);
            itemsPaint.setLinearText(true);
        }
    ...
    private void createLayouts(int widthItems, int widthLabel) {
        ...
        if (!isScrollingPerformed && (valueLayout == null || valueLayout.getWidth() > widthItems)) {
            ...
            valueLayout = new StaticLayout(text != null ? text : "", valuePaint, widthItems, widthLabel > 0 ?
                    Layout.Alignment.ALIGN_CENTER : Layout.Alignment.ALIGN_CENTER, 1, ADDITIONAL_ITEM_HEIGHT, false);
